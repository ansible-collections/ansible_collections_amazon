...
def deactivate(client, hosted_zone_id: str, name: str) -> Dict[str, Any]:
    return client.deactivate_key_signing_key(HostedZoneId=hosted_zone_id, Name=name)


def activate(client, hosted_zone_id: str, name: str) -> Dict[str, Any]:
...
def get_hosted_zone(client, hosted_zone_id: str) -> Dict[str, Any]:
